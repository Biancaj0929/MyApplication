...
public class Physical extends Goals {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        writeArray("physical.txt", physicalArray);
        // Updates goals list
        updateGoalList(physicalArray);
    ...
    public void updateGoalList(String[] goals) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(final AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Toast.makeText(Physical.this, goalPicked, Toast.LENGTH_SHORT).show();
                ...
                builder.setNegativeButton("Edit", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Toast.makeText(Physical.this, goalPicked, Toast.LENGTH_LONG).show();
                    }
                });
                builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {

                        deleteGoal("physical.txt", physicalArray, goals1, goal);
